...
<nav class="site-nav">
    <div class="container">
        <div class="site-navigation">
            <a href="/" class="logo m-0">Trip My Trip <span class="text-primary">.</span></a>
            ...
            <ul class="js-clone-nav d-none d-lg-inline-block text-left site-menu float-right">
                ...
                <li class="has-children">
                    <a href="#">Services</a>
                    <ul class="dropdown">
                        <x-nav-home-link href="{{ route('guides') }}" :active="request()->routeIs('guides')">
                            {{ __('Tourist Guide Booking') }}
                        </x-nav-home-link>
                        <x-nav-home-link href="{{ route('vehicles') }}" :active="request()->routeIs('vehicles')">
                            {{ __('Vehicle Booking') }}
                        </x-nav-home-link>
                    </ul>
                </li>

                <x-nav-home-link href="{{ route('about') }}" :active="request()->routeIs('about')">
                    {{ __('About') }}
                </x-nav-home-link>

                <x-nav-home-link href="{{ route('contact-us') }}" :active="request()->routeIs('contact-us')">
                    {{ __('Contact Us') }}
                </x-nav-home-link>
