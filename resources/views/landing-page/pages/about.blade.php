            ...
            <div class="row">
                <div class="col-lg-7">
                    <div class="owl-single dots-absolute owl-carousel">
                        <img src="{{asset('landing-page/images/slider-1.jpg')}}" alt="Free HTML Template by Untree.co"
                             class="img-fluid rounded-20">
                        <img src="{{asset('landing-page/images/slider-2.jpg')}}" alt="Free HTML Template by Untree.co"
                             class="img-fluid rounded-20">
                        <img src="{{asset('landing-page/images/slider-3.jpg')}}" alt="Free HTML Template by Untree.co"
                             class="img-fluid rounded-20">
                        <img src="{{asset('landing-page/images/slider-4.jpg')}}" alt="Free HTML Template by Untree.co"
                             class="img-fluid rounded-20">
                        <img src="{{asset('landing-page/images/slider-5.jpg')}}" alt="Free HTML Template by Untree.co"
                             class="img-fluid rounded-20">
                    </div>
                </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-3 mb-4">
                    <div class="team">
                        <img src="{{asset('landing-page/images/person_1.jpg')}}" alt="Image" class="img-fluid mb-4 rounded-20">
                        <div class="px-3">
                ...
                <div class="col-lg-3 mb-4">
                    <div class="team">
                        <img src="{{asset('landing-page/images/person_2.jpg')}}" alt="Image" class="img-fluid mb-4 rounded-20">
                        <div class="px-3">
                ...
                <div class="col-lg-3 mb-4">
                    <div class="team">
                        <img src="{{asset('landing-page/images/person_4.jpg')}}" alt="Image" class="img-fluid mb-4 rounded-20">
                        <div class="px-3">
                ...
                <div class="col-lg-3 mb-4">
                    <div class="team">
                        <img src="{{asset('landing-page/images/person_3.jpg')}}" alt="Image" class="img-fluid mb-4 rounded-20">
                        <div class="px-3">
        ...
        <div class="container">
            <div class="row text-center">
                <div class="col-md-12">
                    ...
                    <p class="mb-0"><a href="#"
                                       class="btn btn-outline-white text-white btn-md font-weight-bold">Get in touch</a>
                    </p>
                </div>
            </div>
        </div>
